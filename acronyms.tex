...
\newdualentry{SN}{}{Serving Node}{A Data Sublayer component that indexes, cleans, stores, and ultimately serves the Open Information to the end users. Denoted as \node\ when it is in Normal mode, and \publicGoodNode\ when it is in Public Good mode.}
