...
\newdualentry{SN}{}{Serving Node}{A Data Sublayer component that indexes, cleans, stores, and ultimately serves the Open Information to the end users.}
...
\newdualentry{GI}{}{Global Indexer}{A \glsfmtlong{DLS} component that facilitates coordination among Serving Nodes and engages with the \glsfmtlong{VLS}.}
