...
Each successful request served on the \gls{DSL} is recorded, and the corresponding \glsfmtlong{Fee} paid by requesters are distributed to the \gls{Node}, see \Cref{subsubsec:operation_pool} for more details.
