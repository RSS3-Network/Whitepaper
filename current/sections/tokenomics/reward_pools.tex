...
The \glsfmtlong{R3N} incentivizes network participants with a portion of \$RSS3's total supply, referred to as the \glsfirst{NR}, and allocates it into reward pools.
...
The tax applies to the \glsfmtlong{NR} being allocated to the Node's \stakingPool\ but does not apply to the staked tokens.
...
As Public Good Nodes do not participate in incentivization, they collectively share a \glsfirst{PGP} for network participants to show their support toward Public Goods provision.
