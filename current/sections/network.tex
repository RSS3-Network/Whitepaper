...
This is achieved by introducing a crucial standard, known as the \gls{Protocol}, see \Cref{subsec:protocol}, enabling network-agnostic applications to be built on top of the \gls{DSL}.
