...
\begin{enumerate}
    ...
    \item A Node can be operated in either a Normal mode as \node, or a Public Good mode as \publicGoodNode. A Normal Node is eligible for \glsfmtlong{NR}, but requires a deposit of \$RSS3. A Public Good Node is ineligible for \glsfmtlong{NR}, but requires no deposit.
