...
Each successful request served on the \gls{DSL} is recorded and the corresponding \glsfmtlong{Fee} paid by the requesters are distributed to the \gls{SN}, see \Cref{subsubsec:operation_pool} for more details.
