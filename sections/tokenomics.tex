...
\begin{itemize}
    \item the Node's \deposit\ will be slashed by a precentage determined by the network
    \item the Node's \stakingPool\ will be slashed by a precentage determined by the Network
    \item the Node's \networkReward\ will be slashed by a precentage determined by the Network
    \item the Node's \reliabilityScore\ will be negatively impacted, resulting in a lower chance to receive requests on the \gls{DSL}
\end{itemize}
