...
In \Cref{sec:VSL}, we describe the intentions behind the \gls{VSL}'s incentive mechanism, here we introduce the detailed \glsfmtlong{NR} calculation and allocation formulas separately.
...
For the \glsfmtlong{PGP}, the tax rate is set by the Network to collect donations to support Public Good initiatives and clauses.
