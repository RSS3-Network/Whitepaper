...
The \glsfmtlong{NO} can set a tax rate, \taxRate, which is applied to its \stakingPool, in conjunction with its \deposit\ to determine the amount of \gls{Tax} collected from its \stakingPool.
