...
Network participants are incentivized to secure the Network by staking or entrusting their tokens to a \glsfmtlong{SN}.
...
A Public Good Node does not have a stakingPool and does not participate in any form of incentivization. Instead, network participants entrust such a Node, and their tokens are stored into a \glsfmtlong{PGP}. Higher trust Nodes has an increased likelihood of receiving requests.
